...
namespace InventoryServices.InventoryManagement
{
   public class ProductCategoryDal
   {
       ...
       public IEnumerable<ProductCategory> GETAllProductCategory() {
           return _context.ProductCategorys.Where(m=>m.IsArchive==false);
       ...
       {
           var result = _context.ProductCategorys.FirstOrDefault(m => m.Id == Id && m.IsArchive == false);
           return result;
       }
       public IEnumerable<ProductCategory> GETbySearch(int? Id, string name, string code)
       {
           var result = _context.ProductCategorys.Where(t => t.Code == code || t.Name == name && t.IsArchive == false).ToList();
           return result;
       }
       ...
       public string[] SaveAndEdit(ProductCategory data)
       {
           ...
           try
           {
               ...
               else
               {
                   ...
                   data.LastUpdateBy = DateTime.Now.ToString("MM/dd/yy");
       ...
       public dynamic Dropdown()
       {
           ...
           //var ProductCategorys = ;
               ...
               var ProductCategorys = _context.ProductCategorys.Where(m => m.IsActive == true && m.IsArchive == false).Select(m => new { m.Id, m.Name }).ToList();
           return ProductCategorys;
           
          

       }
       public IEnumerable<ProductCategory> Autocomplete(string term)
       {
           IEnumerable<ProductCategory> ProductCategorys = from ProductCategory in _context.ProductCategorys
                                    ...
                                    && (ProductCategory.Code.Contains(term) || ProductCategory.Name.Contains(term))
