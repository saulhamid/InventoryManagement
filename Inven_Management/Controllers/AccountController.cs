...
using Inven_Management.Filters;
using Inven_Management.Models;
...
namespace Inven_Management.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(User model, string returnUrl)
        {
            try
            {
                bool count = _repo.GETAllUser.Any(m => m.UserName.TrimEnd() == model.UserName.TrimEnd() && m.Password.TrimEnd() == model.Password.TrimEnd());
                if (count == true)
                {
