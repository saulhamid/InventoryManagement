...
namespace Inven_Management.Areas.Config.Controllers
{
    public class MarketController : Controller
    {
        ...
        // GET: /Config/Market/
        #region Declare
        MarketRepo _repo = new MarketRepo();
        #endregion Declare
        public ActionResult Index()
        {
            Market vm = new Market();
            vm.IsActive = true;
            return View(vm);
        }

        //public JsonResult _index(JQueryDataTableParamModel param ) {
        //    IEnumerable<Market> vm = _repo.GETAllMarket;
        ...
        public ActionResult _index(JQueryDataTableParamModel param)//EmployeeId
        {
            ...
            var getAllData = _repo.GETAllMarket;
            IEnumerable<Market> filteredData;
            ...
            Func<Market, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(Market vm, string IsActive)
        {
        ...
        public ActionResult Edit(Market vm)
        {
            string[] result = new string[3];
            try
            {
