...
namespace Inven_Management.Areas.Config.Controllers
{
    public class CustomerController : Controller
    {
        ...
        //    IEnumerable<Customer> vm = _repo.GETAllCustomer;
        ...
        public ActionResult _index(JQueryDataTableParamModel param)//EmployeeId
        {
            ...
            var getAllData = _repo.GETAllCustomer;
            IEnumerable<Customer> filteredData;
            ...
            Func<Customer, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
                                                           sortColumnIndex == 2 && isSortable_2 ? c.Code :
                                                           sortColumnIndex == 3 && isSortable_3 ? c.Mobile :
                                                           sortColumnIndex == 3 && isSortable_3 ? c.Email :
                                                           sortColumnIndex == 3 && isSortable_3 ? c.PresentAddress :
                                                           sortColumnIndex == 3 && isSortable_3 ? c.PermanentAddress :
        ...
        [HttpPost]
        public ActionResult Create(Customer vm, string IsActive)
        {
        ...
        public ActionResult Edit(Customer vm)
        {
            string[] result = new string[3];
            try
            {
