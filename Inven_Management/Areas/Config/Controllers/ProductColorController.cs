...
namespace Inven_Management.Areas.Config.Controllers
{
    ...
    {
        #region Declare
        ProductColorRepo _repo = new ProductColorRepo();
        #endregion Declare
        ...
        //    IEnumerable<ProductColor> vm = _repo.GETAllProductColor;
        ...
        public ActionResult _index(JQueryDataTableParamModel param)//EmployeeId
        {
            ...
            var getAllData = _repo.GETAllProductColor;
        ...
        //}
        [HttpPost]
        public ActionResult Create(ProductColor vm, string IsActive)
        {
        ...
        public ActionResult Edit(ProductColor vm)
        {
            string[] result = new string[3];
            try
            {
        ...
        {
            ProductColor vm = _repo.GetSigle(Id);
            return Json(vm, JsonRequestBehavior.AllowGet);
        }
