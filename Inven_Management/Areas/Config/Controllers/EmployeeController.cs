...
namespace Inven_Management.Areas.Config.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        {
            var user = _repo.GetSigle(id);
            return PartialView( user);
        }
        //public JsonResult _index(JQueryDataTableParamModel param ) {
        //    IEnumerable<Employee> vm = _repo.GETAllEmployee;
        ...
        public ActionResult _index(JQueryDataTableParamModel param)//EmployeeId
        {
            ...
            var getAllData = _repo.GETAllEmployee;
            ...
            Func<Employee, string> orderingFunction = (c => sortColumnIndex == 1 && isSortable_1 ? c.Name :
        ...
        [HttpPost]
        public ActionResult Create(Employee vm, string IsActive)
        {
        ...
        public ActionResult Edit(Employee vm)
        {
            string[] result = new string[3];
            try
            {
