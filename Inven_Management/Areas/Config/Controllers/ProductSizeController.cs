...
namespace Inven_Management.Areas.Config.Controllers
{
    ...
    {
        #region Declare
        ProductSizeRepo _repo = new ProductSizeRepo();
        #endregion Declare
        ...
        //    IEnumerable<ProductSize> vm = _repo.GETAllProductSize;
        ...
        public ActionResult _index(JQueryDataTableParamModel param)//EmployeeId
        {
            ...
            var getAllData = _repo.GETAllProductSize;
        ...
        //}
        [HttpPost]
        public ActionResult Create(ProductSize vm, string IsActive)
        {
        ...
        public ActionResult Edit(ProductSize vm)
        {
            string[] result = new string[3];
            try
            {
        ...
        {
            ProductSize vm = _repo.GetSigle(Id);
            return Json(vm, JsonRequestBehavior.AllowGet);
        }
    }
}
